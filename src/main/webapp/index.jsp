    ...
    <div class="layui-layout layui-layout-admin">
                ...
                <li class="layui-nav-item" lay-unselect>
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd layadmin-event="logout" style="text-align: center;"><a
                                href="SignServlet?action=signOut">退出</a></dd>
                    </dl>
                </li>
                ...
                <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu"
                    ...
                    <c:forEach items="${requestScope.actionsList}" var="action">
                        <li data-name="home" class="layui-nav-item layui-nav-itemed">
                            <a href="javascript:" lay-tips="${action.title}" lay-direction="2">
                                    <%--<i class="layui-icon layui-icon-home"></i>--%>
                                <cite>${action.title}</cite>
                            </a>
                            <dl class="layui-nav-child">
                                <c:forEach items="${requestScope.allActionsList}" var="allActions">
                                    <c:if test="${action.id == allActions.pId}">
                                        <dd data-name="${action.title}">
                                            <a href="#">${allActions.title}</a>
                                        </dd>
                                    </c:if>
                                </c:forEach>
                            </dl>
        ...
        <div class="layadmin-pagetabs" id="LAY_app_tabs">
            ...
            <div class="layui-tab" lay-unauto lay-allowClose="true" lay-filter="layadmin-layout-tabs">
                <ul class="layui-tab-title" id="LAY_app_tabsheader">
                    <li lay-id="homepage.jsp" lay-attr="homepage.jsp" class="layui-this"><i
        ...
        <div class="layui-body" id="LAY_app_body">
            <div class="layadmin-tabsbody-item layui-show">
                <iframe src="homepage.jsp" frameborder="0" class="layadmin-iframe"></iframe>
            </div>
        </div>
